...
import { Phone, Mail, MapPin, Clock, Users, Shield, Award, ChevronRight, Menu, X, Calendar, FlaskConical, Heart, Brain, Droplets, Activity, ClipboardList } from 'lucide-react';

// Keeping the original image file paths as requested.
// Note: These paths will not resolve in this environment because they point to local files.
// For a live application, you would need to ensure these images are properly served.
...
const Header = () => {
    ...
    // The 'Home Collection' and 'View Reports' links have been removed as requested.
    const navItems = [
        { name: 'Home', href: '#home' },
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center py-4">
                    <div className="flex items-center">
                        {/* The image source is now back to the original local path */}
                        <img src={labLogo} alt="General Diagnostics Logo" className="h-12 w-12 mr-4 rounded-full" />
                        <h1 className="text-2xl font-bold text-gray-900">General Diagnostics</h1>
                    </div>

                    <nav className="hidden lg:flex space-x-6">
                        {navItems.map((item, index) => (
                            <a key={index} href={item.href} className="text-gray-700 hover:text-blue-600 font-medium transition-colors hover:underline underline-offset-4">
                                {item.name}
                            </a>
                        ))}
                    </nav>
                ...
                {isMenuOpen && (
                    <nav className="lg:hidden pb-4 transition-all duration-300 ease-in-out">
                        <div className="flex flex-col space-y-2">
                            {navItems.map((item, index) => (
                                <a key={index} href={item.href} className="text-gray-700 hover:text-blue-600 font-medium py-2 px-4 rounded-lg transition-colors hover:bg-gray-100">
                                    {item.name}
                                </a>
                            ))}
                        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-8 text-sm">
                <div className="flex items-center text-gray-700">
                    ...
                    <span className="ml-1">9373999536</span>
                </div>
                <div className="flex items-center text-gray-700">
                ...
                <div className="flex items-center text-gray-700">
                    ...
                    <a href="https://maps.google.com/?cid=4619259872661213091&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQ8" target="_blank" rel="noopener noreferrer" className="ml-1 hover:text-blue-600 underline transition-colors">Shop No. 36 A1, Majestique Manhattan, Bawadi Road, Wagholi, Pune-412207</a>
                </div>
            </div>
        </div>
    </section>
...
const WhyChooseUs = () => (
    <Section id="why-choose-us" title="Why Choose General Diagnostics?" subtitle="Trusted by thousands of patients and healthcare providers across the region">
...
const AboutSection = () => (
    <Section id="about" title="About General Diagnostics">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                <h3 className="text-3xl font-bold text-gray-900 mb-6">About General Diagnostics</h3>
                <p className="text-lg text-gray-600 mb-6">
                    General Diagnostics has been at the forefront of providing accurate, reliable, and timely diagnostic services to patients and healthcare providers. We are an authorized collection center for Parvati Collection Center in Wagholi, Pune.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                    ...
                    <p className="text-gray-300">9373999536</p>
                </div>
                ...
                <div className="text-center">
                    ...
                    <p className="text-gray-300">maheshdapkeakar2016@gmail.com</p>
                </div>
                ...
                <div className="text-center">
                    ...
                    <p className="text-gray-300">
                        <a href="https://maps.google.com/?cid=4619259872661213091&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQ9" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 underline transition-colors">
            ...
            <div className="max-w-4xl mx-auto mt-12">
                <h4 className="text-xl font-semibold text-center mb-4">Our Location</h4>
                <div className="relative overflow-hidden rounded-xl shadow-lg">
                    <a href="https://maps.google.com/?cid=4619259872661213091&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQ9" target="_blank" rel="noopener noreferrer">
                        {/* The image source is now back to the original local path */}
                        <img
                            src={labLocationImage}
                            alt="Map showing the location of General Diagnostics"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-4 gap-8">
                <div>
                    <div className="flex items-center mb-4">
                        {/* The image source is now back to the original local path */}
                        <img src={labLogo} alt="General Diagnostics Logo" className="h-8 w-8 mr-3 rounded-full" />
            ...
            <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm">
                <p className="text-gray-400">
                    © 2025 General Diagnostics. All rights reserved. | Privacy Policy | Terms of Service
                </p>
            </div>
        </div>
    </footer>
